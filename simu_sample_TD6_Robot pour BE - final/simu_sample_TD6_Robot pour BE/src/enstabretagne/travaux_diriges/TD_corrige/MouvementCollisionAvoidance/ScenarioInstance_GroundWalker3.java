...
public class ScenarioInstance_GroundWalker3 implements IScenarioInstance {

	@Override
	public IScenario getScenarioInstance(long seed) {
		ScenMvtCollisionAvoidanceFeatures mcaf = new ScenMvtCollisionAvoidanceFeatures("RbScen3");
		...
		RobotInit ri = new RobotInit("RI", Color.AQUA, new Point3D(5, 14, 0.5), new Point3D(0, 0, 0), false, new Point3D(20, 1, 1),100,600);
		...
		ScenMvtCollisionAvoidance scen = new ScenMvtCollisionAvoidance(new ScenarioId("Scen3"), mcaf, start, end);
		return scen;
	}
