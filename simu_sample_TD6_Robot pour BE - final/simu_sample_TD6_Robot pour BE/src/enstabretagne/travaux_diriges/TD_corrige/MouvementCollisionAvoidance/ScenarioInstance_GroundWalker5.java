...
public class ScenarioInstance_GroundWalker5 implements IScenarioInstance {

	@Override
	public IScenario getScenarioInstance(long seed) {
		ScenMvtCollisionAvoidanceFeatures mcaf = new ScenMvtCollisionAvoidanceFeatures("RbScen5");
		...
		RobotInit ri = new RobotInit("RI", Color.AQUA, new Point3D(1, 1, 0.5), new Point3D(0, 0, 90), false, new Point3D(20, 1, 1),100,600);
		...
		ScenMvtCollisionAvoidance scen = new ScenMvtCollisionAvoidance(new ScenarioId("Scen5"), mcaf, start, end);
		return scen;
	}
