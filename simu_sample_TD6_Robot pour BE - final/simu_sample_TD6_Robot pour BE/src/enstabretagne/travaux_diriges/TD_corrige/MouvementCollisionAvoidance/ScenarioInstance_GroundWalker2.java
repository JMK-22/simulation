...
public class ScenarioInstance_GroundWalker2 implements IScenarioInstance {

	@Override
	public IScenario getScenarioInstance(long seed) {
		ScenMvtCollisionAvoidanceFeatures mcaf = new ScenMvtCollisionAvoidanceFeatures("RbScen2");

		// Construction de l'environnement

		List<Point3D> lP;
		// Les objets qui sont des  murs extérieurs sont de type 2 
		// les autre mur type 3
		//le reste type 1 (ex: chaise)
		
		
		//Trac� du mur d'enceinte
		...
		//Trac� du mur en zigzag
		WallFeatures wf2 = new WallFeatures("RF", Color.ORANGE, 3, 0.1, 2);
		WallInit wi2;
		lP = new ArrayList<>();
		...
		//Trac� du mur entourant le robot ennemi
		WallInit wi3;
		lP = new ArrayList<>();
		...
		RobotInit ri = new RobotInit("RI", Color.AQUA, new Point3D(15, 1, 0.5), new Point3D(0, 0, 90), false, new Point3D(20, 1, 1),100,600);
		...
		ScenMvtCollisionAvoidance scen = new ScenMvtCollisionAvoidance(new ScenarioId("Scen2"), mcaf, start, end);
		return scen;
	}
